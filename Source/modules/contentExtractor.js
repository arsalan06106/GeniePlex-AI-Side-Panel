...
export class ContentExtractorManager {
    ...
    modal.innerHTML = `
      <div class="extraction-modal-content">
        <div class="extraction-modal-header">
          ...
          <button class="extraction-modal-close" aria-label="${this._t('extractionModalClose') || 'Close'}">
  ...
  populateExtractionOptions() {
    ...
    const sortedKeys = [
      ...topExtractors.filter(key => extractorKeys.includes(key)),
      ...extractorKeys.filter(key => !topExtractors.includes(key))
    ];
